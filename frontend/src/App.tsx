...
import FilesManager from "./components/FilesManager"; // Add this import
      ...
      <main className="max-w-5xl mx-auto py-6 px-4 sm:px-6">
        <div className="md:flex md:space-x-6">
          ...
          <div className="md:w-1/3">
            ...
            {/* Add the Files Manager component */}
            <FilesManager className="mt-5" />
          </div>
          ...
          <div className="md:w-2/3 mt-6 md:mt-0">
            ...
            {!loading && !error && articles && articles.items.length === 0 && (
              <div className="bg-white rounded-ios shadow-ios p-8 text-center">
                <svg
                  className="mx-auto h-12 w-12 text-ios-gray-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="mt-4 text-ios-gray-600">
