...
import { NewsItem, ReportGenerateResp } from '../types';
...
const FilesSection: React.FC = () => {
  ...
  const [report, setReport] = useState<ReportGenerateResp | null>(null);
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-white rounded-ios shadow-ios p-5">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-sm font-semibold text-ios-gray-800">Saved Files</h3>
              <button 
                onClick={fetchFiles}
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="text-xs text-uoft-blue hover:text-uoft-blue-600 transition-colors"
                  >
                    {selectedArticles.length === fileContent.length ? 'Deselect All' : 'Select All'}
                  </button>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex mt-1 items-center text-xs">
                        ...
                        <span className="text-ios-gray-500">{formatDate(article.publish_timestamp)}</span>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          {report && (
            <div className="bg-white rounded-ios shadow-ios p-5 mt-5">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-sm font-semibold text-ios-gray-800">Generated Report</h3>
                <a
                  href={`/data/info/files/${encodeURIComponent(report.report_file)}`}
                  download
              ...
              {report.key_points.length > 0 && (
                <div className="border-t border-ios-gray-200 pt-4 mt-4">
                  <h4 className="text-sm font-medium text-ios-gray-800 mb-2">Key Points</h4>
              ...
              <div className="border-t border-ios-gray-200 pt-4 mt-4">
                <h4 className="text-sm font-medium text-ios-gray-800 mb-2">Full Report</h4>
        ...
        <div className="bg-white rounded-ios shadow-ios p-5">
          ...
          <div className="space-y-3">
            ...
            <button 
              ...
              disabled={!selectedFile || selectedArticles.length === 0 || generatingReport}
              className={`w-full flex items-center justify-center py-2.5 px-4 rounded-ios font-medium text-sm transition duration-150 ${
                !selectedFile || selectedArticles.length === 0 || generatingReport
          ...
          {selectedArticles.length > 0 && (
            <div className="mt-4 pt-4 border-t border-ios-gray-200">
              <h4 className="text-xs font-medium text-ios-gray-700 mb-2">Selected Articles</h4>
              <div className="max-h-56 overflow-y-auto">
                {selectedArticles.map(article => (
                  ...
                  >
                    <span className="truncate max-w-[180px] text-ios-gray-800">{article.title}</span>
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
