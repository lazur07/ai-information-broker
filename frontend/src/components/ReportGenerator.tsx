    ...
    <div>
      ...
      {showOptions && (
        <div className="mt-4 p-4 border border-ios-gray-200 rounded-ios">
          <h4 className="text-sm font-medium text-ios-gray-800 mb-3">
            Report Options
          </h4>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-ios-gray-600 mb-2">
                ...
                If no articles are selected, all articles in the selected file
                will be included.
              </p>
            </div>
          </div>
      ...
      {showResult && generatedReport && (
        <div className="mt-4 p-4 border border-ios-gray-200 rounded-ios bg-ios-gray-50">
          <div className="flex justify-between items-center mb-3">
            <h4 className="text-sm font-medium text-ios-gray-800">
              Report Generated
            </h4>
            <button
          ...
          <div className="text-sm text-ios-gray-800">
            ...
            <p className="mt-2 text-xs text-ios-gray-600">
              Generated on{" "}
              {new Date(generatedReport.timestamp * 1000).toLocaleString()}
            </p>
